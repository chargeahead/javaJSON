...
public class App 
{
    public static void main( String[] args )
    {
    	try {
    		...
    		InputStream inputStream = new FileInputStream(new File("/home/parallels/demo/persons.json"));
            ...
            mapper.writeValue(new File("/home/parallels/demo/personsOut.json"), person);
            inputStream.close();
    	}
    	catch(Exception e) {
    		e.printStackTrace();
